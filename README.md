...
5. Adjust and save settings in the GUI.
6. Start the connection program and wake the controller.
...
Reusable hardware probes and BAT launchers are included under `tests/`.
