...
EN_TEXT = {
    ...
    "低頻補償": "HF → LF Mix",
    "高頻補償": "LF → HF Mix",
    "LF 頻率命令值": "LF Freq Cmd",
    "HF 頻率命令值": "HF Freq Cmd",
    "最大振幅": "Max Amp",
    "按鍵映射": "Buttons",
    "搖桿方向映射": "Stick Map",
    "音訊震動": "Audio Haptics",
    ...
    "依手把傾斜角度修正瞄準軸向，減少左右與上下串軸。\n建議開啟；關閉後使用固定 X／Z 軸。": (
        ...
        "vertical axis mixing.\nRecommended; disable it to use fixed X/Z axes."
    ),    "陀螺儀反應": "Gyro Response",
    "搖桿感度": "Stick Sens",
    "滑鼠感度": "Mouse Sens",
    "最大傾角": "Max Tilt",
    ...
    "輸入的整數格式不正確。\n\n請確認頻率命令值與最大振幅只包含有效的整數。":
        "Invalid integer format.\n\nFrequency commands and max amplitude must be integers.",
    ...
    "低頻震動通道的強度倍率。\n\n設定範圍：0.00 ～ 1.00\n0.00 = 關閉\n1.00 = 完整強度":
        "LF rumble strength multiplier.\n\nRange: 0.00–1.00\n0.00 = off\n1.00 = full strength",
    "高頻震動通道的強度倍率。\n\n設定範圍：0.00 ～ 1.00\n0.00 = 關閉\n1.00 = 完整強度":
        "HF rumble strength multiplier.\n\nRange: 0.00–1.00\n0.00 = off\n1.00 = full strength",
    "低頻震動的響應曲線。\n\n設定範圍：0.10 ～ 5.00\n1.00 = 線性，保持原始比例\n小於 1.00 = 增強較弱的震動\n大於 1.00 = 壓低較弱的震動":
        "LF response curve.\n\nRange: 0.10–5.00\n1.00 = linear\nBelow 1.00 boosts weak rumble\nAbove 1.00 reduces weak rumble",
    "高頻震動的響應曲線。\n\n設定範圍：0.10 ～ 5.00\n1.00 = 線性，保持原始比例\n小於 1.00 = 增強較弱的震動\n大於 1.00 = 壓低較弱的震動":
        "HF response curve.\n\nRange: 0.10–5.00\n1.00 = linear\nBelow 1.00 boosts weak rumble\nAbove 1.00 reduces weak rumble",
    "將一部分 HF 最終振幅加入 LF 通道。\n\n設定範圍：0.00 ～ 1.00\n0.00 = 不補償\n0.50 = 加入 HF 振幅的 50%":
        "Mix part of final HF amplitude into LF.\n\nRange: 0.00–1.00\n0.00 = none\n0.50 = mix 50%",
    "將一部分 LF 最終振幅加入 HF 通道。\n\n設定範圍：0.00 ～ 1.00\n0.00 = 不補償\n0.50 = 加入 LF 振幅的 50%":
        "Mix part of final LF amplitude into HF.\n\nRange: 0.00–1.00\n0.00 = none\n0.50 = mix 50%",
    "LF 的 HD Rumble 2 頻率命令值。\n\n可設定範圍：1 ～ 511\n上游預設：225\n一般建議：維持 225\n\n注意：此數值不是直接的實際 Hz。":
        "LF HD Rumble 2 frequency command.\n\nCommand range: 1–511\nUpstream default: 225\nGeneral recommendation: keep 225\n\nThis is not a direct Hz value.",
    "HF 的 HD Rumble 2 頻率命令值。\n\n可設定範圍：1 ～ 511\n上游預設：481\n一般建議：維持 481\n\n注意：此數值不是直接的實際 Hz。":
        "HF HD Rumble 2 frequency command.\n\nCommand range: 1–511\nUpstream default: 481\nGeneral recommendation: keep 481\n\nThis is not a direct Hz value.",
    "限制 LF 與 HF 的最大振幅輸出。\n\n設定範圍：0 ～ 1023\n輸入接近極限數值有可能損壞控制器馬達。\n\n本專案建議預設：800":
        "Limits maximum LF/HF amplitude.\n\nRange: 0–1023\nValues near the limit may damage the controller motors.\n\nRecommended default: 800",
    ...
    "LF 頻率命令值必須介於 1 ～ 511。": "LF frequency command must be 1–511.",
    "HF 頻率命令值必須介於 1 ～ 511。": "HF frequency command must be 1–511.",
