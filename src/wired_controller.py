...
class WiredController:
    ...
    def connection_rumble(self):
        """Match the native BLE/ESP32 two-pulse connection and PIN haptic."""
        def worker():
            for amplitude, duration in ((800, 0.08), (0, 0.10), (800, 0.08), (0, 0.0)):
                self.send_pro_rumble(225, amplitude, 481, amplitude)
                if duration:
                    time.sleep(duration)
