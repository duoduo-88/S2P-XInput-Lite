# S2P-XInput-Lite v0.7.2 使用手冊

本手冊介紹 v0.7.2 的安裝、連線、方案、搖桿、按鍵映射、陀螺儀、震動、
...
v0.7.2 提供兩種不需要持續開啟 Windows 程式的獨立輸出：
...
3. 確認 ESP32 已連線且使用隨附的 `S2P-FW 1.0.1` 韌體。
4. 點擊底部 **ESP32 ▼**。
...
5. 若程式沒有重新找到裝置，拔除後重新插入 ESP32，再按
   **重新啟動連線**。
...
> [!NOTE]
> 本手冊適用於 S2P-XInput-Lite v0.7.2；後續版本請以程式內的問號說明與最新發佈說明為準。
