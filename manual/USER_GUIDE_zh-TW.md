# S2P-XInput-Lite v0.7.8 使用手冊

本手冊介紹 v0.7.8 的安裝、連線、方案、搖桿、按鍵映射、陀螺儀、震動、
...
v0.7.8 提供三種不需要持續開啟 Windows 程式的獨立輸出：
...
高電量亮四顆。隨附的 S2P-FW 1.0.4 在獨立模式也能顯示，不需要持續開啟
Windows 程式。
...
2. 程式先讀取目前韌體版本，並與內建的 `S2P-FW 1.0.4` 比對。
...
3. 確認 ESP32 已連線且使用隨附的 `S2P-FW 1.0.4` 韌體。
4. 點擊底部 **ESP32 ▼**。
...
> [!NOTE]
> 本手冊適用於 S2P-XInput-Lite v0.7.8；後續版本請以程式內的問號說明與最新發佈說明為準。
