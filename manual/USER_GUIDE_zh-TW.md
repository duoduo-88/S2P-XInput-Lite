# S2P-XInput-Lite v0.7.1 使用手冊

本手冊介紹 v0.7.1 的安裝、連線、方案、搖桿、按鍵映射、陀螺儀、震動、
...
v0.7.1 提供兩種不需要持續開啟 Windows 程式的獨立輸出：
...
> [!NOTE]
> 本手冊適用於 S2P-XInput-Lite v0.7.1；後續版本請以程式內的問號說明與最新發佈說明為準。
